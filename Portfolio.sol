...
contract Portfolio{
  ...
  string public imageLink="QmQMvgdoTbuVCg6dk9UPLfZFXBYjFxfRi2yeVYxNADn3Tt";
  string public description="I have experience of more than a year in blockchain development and have created some good web3 projects.";
  string public resumeLink="QmUyEjtbrKjnk8DLLaiL4afQGvMbjGAyKhzVagmZaatmKr";
  uint projectCount;
  uint educationCount;
